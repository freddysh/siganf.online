    ...
    <v-row>
      ...
      <v-col cols="12" class="px-3">
        <v-card elevation="3" outlined>
          <v-card-title>
            <h3 class="red--text">Asesorias</h3>
          </v-card-title>
          <v-divider></v-divider>
          <v-card-text>
            <v-row>
              <v-col cols="12" sm="4">
                <v-container>
                  <v-row>
                    ...
                    <v-col cols="12" sm='12'>
                      <v-select autocomplete :items="dres" item-value="id" item-text="nombre" label="Dre"></v-select>
                    </v-col>
                    <v-col cols="12" sm='12'>
                      <v-select autocomplete :items="ugeles" item-value="nro" item-text="nombre" label="Ugel"></v-select>
                    </v-col>
                    <v-col cols="12" sm='12'>
                      ...
                      <template v-slot:default>
                        ...
                        <tbody>
                          <tr v-for="(item,i) in asesorias" :key="i">
                            ...
                            <td>
                              <v-btn class="mx-2" dark small color="primary" @click="asesoriaShow(item.id)">
                                <v-icon dark>
                                  mdi-eye
                                </v-icon>({{ item.dias }} Dias) Ver
                              </v-btn>
                              <v-btn class="mx-2" dark small color="red" @click="confir_eliminar(item.id)">
                                <v-icon dark>
                                  mdi-trash-can
                                </v-icon>
                              </v-btn>
